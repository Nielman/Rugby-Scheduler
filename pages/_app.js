    ...
    <>
      ...
      <style jsx global>{`
        @media print {
          ...
          .print-card { border: 1px solid #cbd5e1; border-radius: 6px; padding: 8px; margin-bottom: 8px; background: #fff; }
          ...
          .print-footer { margin-top: 8mm; text-align: right; font-size: 10pt; color: #475569; }
        }
